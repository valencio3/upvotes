...
const SignUP = ({ navigation }) => {
  ...
  const showToast = () => {
    ToastAndroid.show("Erro fazer cadastro!", ToastAndroid.LONG)
  }
  const onSubmit = data => {
    if (hasError) {
        return
  ...
  return (
    <Container>
      ...
      <Controller
        ...
        defaultValue=''
      />
      <ButtonSignUp loading={postData.loading} title='Cadastrar' onPress={handleSubmit(onSubmit)} />
    </Container>
  )
}
